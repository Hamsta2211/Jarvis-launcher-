...
# Skip the first 19 lines of the old file
tail -n +19 app/src/main/java/com/example/data/service/SettingsManager.kt >> app/src/main/java/com/example/data/service/SettingsManager.kt.new
